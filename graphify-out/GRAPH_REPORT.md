...
## Corpus Check
- 205 files · ~55,487 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1256 nodes · 2274 edges · 95 communities (81 shown, 14 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 61 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `05b7159a`
...
Cohesion: 0.14
Nodes (9): GeminiKey, Carbon\CarbonImmutable, Illuminate\Foundation\Testing\RefreshDatabase, Illuminate\Http\Client\ConnectionException, Illuminate\Http\Client\RequestException, Illuminate\Http\UploadedFile, Illuminate\Support\Facades\Http, Illuminate\Support\Facades\Storage (+1 more)
...
Cohesion: 0.08
Nodes (25): busy, clear(), close(), closing, confirming, csrf(), draft, error (+17 more)
...
Cohesion: 0.17
Nodes (13): tones, frameClass(), frameGap(), frameTop(), Groupable, currency, growthPct, mode (+5 more)
...
Cohesion: 0.08
Nodes (23): longDate(), apply, blockRange(), currency, dayKey(), direction, editGroup(), filters (+15 more)
...
### Community 39 - "web.php"
Cohesion: 0.16
Nodes (4): ProfileController, TransactionController, Uploads, Symfony\Component\HttpFoundation\StreamedResponse

### Community 40 - "SetupPicker.vue"
Cohesion: 0.40
Nodes (5): emit, options, props, selected, SETUPS

### Community 41 - "TradeRequest"
Cohesion: 0.32
...
Cohesion: 0.13
Nodes (5): Illuminate\Foundation\Testing\TestCase, BackupTest, ErrorPageTest, RegisterTest, TestCase

### Community 61 - "Controller"
Cohesion: 0.21
Nodes (4): CalendarController, Controller, DashboardController, RuleController
...
Cohesion: 0.08
Nodes (15): BackupDatabase, UserFactory, Illuminate\Console\Command, Illuminate\Database\Eloquent\Factories\Factory, Illuminate\Foundation\Inspiring, Illuminate\Support\Carbon, Illuminate\Support\Facades\Artisan, Illuminate\Support\Facades\File (+7 more)
...
Cohesion: 0.09
Nodes (26): axis, bars, changePct, niceStep(), props, totals, breached, lossPct (+18 more)
...
### Community 85 - "Account"
Cohesion: 0.19
Nodes (3): Account, Illuminate\Database\Eloquent\Relations\HasMany, TradeDayTest

### Community 86 - "Illuminate\Http\Request"
Cohesion: 0.33
Nodes (3): AnalysisController, LoginController, Illuminate\Http\Request
...
### Community 89 - "DropdownMenuSub.vue"
Cohesion: 0.50
...
### Community 94 - "SelectTrigger.vue"
Cohesion: 0.50
...
## Knowledge Gaps
- **420 isolated node(s):** `$schema`, `style`, `typescript`, `config`, `css` (+415 more)
...
- **Why does `cn()` connect `utils.ts` to `button/index.ts`, `Separator.vue`, `DialogContent.vue`, `dropdown-menu/index.ts`, `select/index.ts`, `DropdownMenuCheckboxItem.vue`, `DropdownMenuSubContent.vue`, `SelectContent.vue`, `AnalysisChat.vue`, `DropdownMenuContent.vue`, `Input.vue`, `Tabs.vue`, `dialog/index.ts`, `Progress.vue`, `SelectTrigger.vue`, `Calendar.vue`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `User` connect `User` to `BackupDatabase`, `AdminTest`, `LoginThrottleTest`, `RegisterController`, `GeminiKey`, `TradeImportTest`, `Account`, `Trade`, `Inertia\Response`, `AnalysisChatTest`, `Illuminate\Http\RedirectResponse`, `RuleLimitTest`, `AnalysisTest`, `TestCase`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `Account` connect `Account` to `User`, `Illuminate\Database\Eloquent\Model`, `web.php`, `GeminiKey`, `AccountStats`, `TradeImportTest`, `Trade`, `RuleLimitTest`, `AnalysisChatTest`, `Illuminate\Http\RedirectResponse`, `AnalysisTest`?**
