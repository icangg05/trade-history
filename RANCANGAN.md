...
| Bukti dua tahap: `proofs.link` abadi di dokumen, `proofs.view` hidup 15 detik | dompdf menulis anotasi `/URI` sungguhan, jadi bisa diklik dari dalam PDF. Pemegang laporan berhak membuka kapan pun — laporan pajak bisa baru dibaca berbulan-bulan kemudian — jadi tautan di dokumen tidak boleh hangus. Yang berumur pendek alamat hasil lemparannya, yang mendarat di riwayat browser dan gampang tersalin. Kedaluwarsanya ditumpangkan ke tanda tangan berbatas waktu Laravel, jadi tidak ada jam yang perlu disimpan sendiri. Gambarnya ditanam sebagai data URI di halaman penampil supaya tidak ada alamat berkas kedua; blokir klik kanan di halaman itu kosmetik dan ditandai begitu di komentarnya |
