...
class RuleController extends Controller
{
    public function edit(Request $request): Response|JsonResponse
    {
        ...
        return $this->page('Rules', [
            'rule' => [
                ...
                'max_total_loss' => $this->num($rule?->max_total_loss),
                'max_total_loss_pct' => $this->num($rule?->max_total_loss_pct),
                'max_risk_per_trade' => $this->num($rule?->max_risk_per_trade),
    ...
    public function update(Request $request): RedirectResponse|JsonResponse
    {
        $data = $request->validate([
            ...
            'max_total_loss' => ['nullable', 'numeric', 'gt:0'],
            'max_total_loss_pct' => ['nullable', 'numeric', 'gt:0', 'max:100'],
            'max_risk_per_trade' => ['nullable', 'numeric', 'gt:0'],
